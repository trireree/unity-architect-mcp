import { z } from "zod";
export function registerAutonomousLoopTools(server, client) {
    // Autonomous Build Loop
    server.tool("unity_autonomous_build", "Runs the complete autonomous development loop (Intent -> Inspect State -> Generate Plan -> Snapshot -> Execute Batch -> Scene Validation -> Auto Self-Healing -> Commit/Rollback) in one unified workflow.", {
