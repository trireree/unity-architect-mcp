import { z } from "zod";
export function registerComponentTools(server, client) {
    // Add Component
    server.tool("unity_component_add", "Attaches a component (e.g. Rigidbody, BoxCollider, AudioSource, Light, Camera, or custom MonoBehaviour script) to a GameObject.", {
    ...
    // Remove Component
    server.tool("unity_component_remove", "Removes a component from a GameObject.", {
        target: z.string().describe("Name or Instance ID of the target GameObject"),
    ...
    server.tool("unity_component_get_properties", "Inspects and returns all serialized properties and fields of a component on a GameObject.", {
        target: z.string().describe("Name or Instance ID of the target GameObject"),
    ...
    server.tool("unity_component_set_property", "Sets the value of a specific field or SerializedProperty on a component (supports int, float, bool, string, enum).", {
        target: z.string().describe("Name or Instance ID of the target GameObject"),
