...
export function registerAnimationTools(server: any, client: UnityClient) {
  // Create Animator Controller
  server.tool(
    "unity_animator_create",
  ...
  server.tool(
    ...
    "Adds a state (e.g. 'Idle', 'Run', 'Attack') to an AnimatorController with optional Motion clip.",
    {
  ...
  // Add Parameter
  server.tool(
    "unity_animator_add_param",
    "Adds a parameter (Float, Int, Bool, Trigger) to an AnimatorController.",
    {
      path: z.string().describe("Path to AnimatorController asset"),
