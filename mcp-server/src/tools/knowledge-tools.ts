...
export function registerKnowledgeTools(server: any, client: UnityClient) {
  // Search Knowledge
  server.tool(
    "unity_search_knowledge",
    "Searches the offline local-first Unity Knowledge Base (WheelCollider physics, URP shaders, modern API standards, CharacterController, NavMesh, Object Pooling) for accurate implementation guidance.",
    {
