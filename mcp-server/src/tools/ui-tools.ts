...
export function registerUITools(server: any, client: UnityClient) {
  // Create Canvas
  server.tool(
    "unity_ui_create_canvas",
    "Creates a UI Canvas with CanvasScaler, GraphicRaycaster, and EventSystem.",
    {
  ...
  server.tool(
    ...
    "Creates a UI Element (Panel, Button, Text, Image) under a Canvas with RectTransform layout.",
    {
