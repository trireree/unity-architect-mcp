...
export function registerAssetTools(server: any, client: UnityClient) {
  // Create Prefab
  server.tool(
    "unity_asset_create_prefab",
    "Saves an existing GameObject in the scene as a reusable Prefab asset.",
    {
  ...
  server.tool(
    ...
    "Instantiates a Prefab asset into the current scene with position, rotation, and parent.",
    {
  ...
  server.tool(
    ...
    "Creates a new Material asset with custom shader and hex color.",
    {
  ...
  server.tool(
    "unity_asset_find",
    "Searches the Unity AssetDatabase for assets matching a filter or type (e.g. 't:Prefab', 't:Material', 't:AudioClip', 't:Scene', 'Player').",
    {
