...
export function registerPlayModeTools(server: any, client: UnityClient) {
  // Start Play Mode
  server.tool(
    "unity_playmode_start",
    "Enters Play Mode in the Unity Editor to run the game simulation.",
    {},
    async () => {
  ...
  server.tool(
    "unity_playmode_stop",
    "Exits Play Mode and returns to Edit Mode.",
    {},
    async () => {
  ...
  // Pause Play Mode
  server.tool(
    "unity_playmode_pause",
    "Pauses or unpauses Play Mode simulation.",
    {
  ...
  // Get Console Logs
  server.tool(
    "unity_console_get_logs",
    "Retrieves recent Unity Console messages, warnings, errors, and exception stack traces.",
    {
  ...
  server.tool(
    "unity_console_clear",
    "Clears the Unity Editor Console logs.",
    {},
    async () => {
