...
export function registerScaffoldingTools(server: any, client: UnityClient) {
  // Scaffold Third Person Player
  server.tool(
    "unity_scaffold_player",
    "Generates a complete, ready-to-play Third-Person Character with CharacterController, movement, sprinting, jump physics, and auto-generated C# PlayerController script.",
    {
  ...
  // Scaffold Enemy AI
  server.tool(
    "unity_scaffold_enemy",
    "Generates an intelligent Enemy NPC with NavMeshAgent, automatic player detection, chasing logic, and auto-generated C# EnemyAI script.",
    {
  ...
  server.tool(
    "unity_scaffold_camera",
    "Configures a smooth third-person follow & orbit camera with auto-generated SmoothFollowCamera script.",
    {
