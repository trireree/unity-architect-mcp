...
export function registerMemoryTools(server: any, client: UnityClient) {
  // Memory History
  server.tool(
    "unity_memory_history",
    "Queries the structured persistent development journal (recent AI actions, modified objects, transaction IDs) to understand project modification history without full context bloat.",
    {
